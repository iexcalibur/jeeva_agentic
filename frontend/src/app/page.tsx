    ...
    <div className="h-screen w-full relative overflow-hidden flex flex-col font-sans text-white selection:bg-indigo-500/30 bg-slate-950">
      ...
      <main className="relative z-10 h-full w-full flex flex-col items-center justify-center px-4 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-400">
          Jeeva Agentic <br className="hidden md:block" /> AI Assistant
        </h1>

        <p className="text-lg md:text-xl text-slate-400 max-w-2xl mb-12 leading-relaxed">
          An intelligent chatbot that adapts to your needs. Switch between personas -{" "}
          <span className="text-indigo-400">mentor, investor, technical advisor, or business expert</span> - 
          based on what you ask.{" "}
          <span className="text-indigo-400">
            Just ask naturally, I'll adapt.
          </span>
        </p>
        ...
        >
          ...
          <div className="relative bg-slate-900/60 backdrop-blur-md rounded-3xl p-2 flex flex-col md:flex-row items-center shadow-2xl">
            <div className="flex-1 w-full">
              <textarea
                ...
                placeholder="Ask me anything... I'll adapt to help you best!"
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-6">
            {[
              { label: "Act like my mentor", icon: TrendingUp },
              { label: "I need investment advice", icon: Activity },
              { label: "Help with technical questions", icon: ShieldCheck },
            ].map((item, i) => (
              <button
                key={i}
                type="button"
