...
export default function WelcomeMessage({ onQuickAction }: WelcomeMessageProps) {
  const quickActions = [
    "Act like my mentor and help me with product strategy",
    "I need investment advice on my startup",
    "Help me with the technical implementation",
    "What's the best business strategy for growth?"
  ];
      ...
      <div className="flex-1 max-w-3xl space-y-4">
        <div className="p-6 rounded-2xl backdrop-blur-md border bg-slate-900/50 border-white/5 text-slate-300 rounded-tl-none">
          <p className="leading-relaxed text-[15px] mb-3">
            👋 Welcome to <span className="text-indigo-400 font-semibold">Jeeva Agentic</span>! I'm an AI assistant that adapts to your needs.
          </p>
          <p className="leading-relaxed text-[14px] text-slate-400">
            I can switch between different personas - mentor, investor, technical advisor, or business expert - based on what you need. Just ask naturally and I'll adapt!
          </p>
        </div>
